...
class BotHandlers:
    ...
    def _referrals_text(self, user_id: int) -> str:
        ...
        return (
            ...
            "(фото, видео, кружки, голосовые и всё с пометкой «1 просмотр»).\n\n"
            "<b>Уровень 3</b> — 3 и больше приглашённых\n"
            "Полный доступ без ограничений, включая одноразовые медиа.\n\n"
            "<blockquote>"
            f"{EMOJI_CHECK} Засчитываются только новые пользователи, "
    ...
    async def button_handler(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        if data == "info_how":
            ...
            text = (
                ...
                "<blockquote>"
                f"{EMOJI_CHECK} После подключения вам будут автоматически приходить "
